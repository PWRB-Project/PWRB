Contributing to PWRB Core
============================

The PWRB Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/PWRB-Project/pwrb/blob/master/doc/translation_process.md)
...
The following applies to code changes to the PWRB Core project, and is not to be
confused with overall PWRB Network Protocol consensus changes.

Whether a pull request is merged into PWRB Core rests with the project merge
...
Patches that change PWRB consensus rules are considerably more involved than
...
Where a patchset proposes to change the PWRB consensus, it must have been
...
The project leader is the release manager for each PWRB Core release.
