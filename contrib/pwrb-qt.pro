...
RESOURCES += src/qt/pwrb.qrc src/qt/pwrb_locale.qrc

TRANSLATIONS += src/qt/locale/pwrb_bg.ts \
                src/qt/locale/pwrb_de.ts \
                src/qt/locale/pwrb_en.ts \
                src/qt/locale/pwrb_es.ts \
                src/qt/locale/pwrb_fi.ts \
                src/qt/locale/pwrb_fr.ts \
                src/qt/locale/pwrb_it.ts \
                src/qt/locale/pwrb_ja.ts \
                src/qt/locale/pwrb_pl.ts \
                src/qt/locale/pwrb_pt.ts \
                src/qt/locale/pwrb_ru.ts \
                src/qt/locale/pwrb_sk.ts \
                src/qt/locale/pwrb_sv.ts \
                src/qt/locale/pwrb_vi.ts \
                src/qt/locale/pwrb_zh_CN.ts \
                src/qt/locale/pwrb_zh_TW.ts
