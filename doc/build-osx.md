...
1. Clone the PWRB Core source code:

        git clone https://github.com/PWRB-Project/pwrb
        cd pwrb
...
PWRB Core is now available at `./src/pwrbd`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/PWRB"

    touch "/Users/${USER}/Library/Application Support/PWRB/pwrb.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/PWRB/pwrb.conf"

The first time you run pwrbd, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.

You can monitor the download process by looking at the debug.log file:

    tail -f $HOME/Library/Application\ Support/PWRB/debug.log

Other commands:
-------

    ./src/pwrbd -daemon # Starts the pwrb daemon.
    ./src/pwrb-cli --help # Outputs a list of command-line options.
    ./src/pwrb-cli help # Outputs a list of RPC commands when the daemon is running.
