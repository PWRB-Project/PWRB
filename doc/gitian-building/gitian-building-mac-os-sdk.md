...
The script [extract-osx-sdk.sh](https://github.com/PWRB-Project/pwrb/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
pwrb/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/PWRB-Project/pwrb/blob/master/doc/README_osx.md) for troubleshooting tips.