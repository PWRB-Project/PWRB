...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Pwrb Core pwrb-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  pwrb-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pwrb transaction") + "\n" +
                               "  pwrb-tx [options] -create [commands]   " + _("Create hex-encoded pwrb transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded pwrb transaction
