...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(PWRB);
    unitlist.append(mPWRB);
    unitlist.append(uPWRB);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    ...
    case PWRB:
        return QString("pwrb");
    case mPWRB:
        return QString("mpwrb");
    case uPWRB:
        return QString::fromUtf8("upwrb");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZPWRB)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZPWRB);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZPWRB)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZPWRB));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
