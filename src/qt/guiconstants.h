...
/* Pwrb GUI -- Size of icons in status bar */
...
#define COLOR_UNCONFIRMED QColor(153,0,0)
...
#define QAPP_ORG_NAME "PWRB"
#define QAPP_ORG_DOMAIN "pwrb.org"
#define QAPP_APP_NAME_DEFAULT "PWRB-Qt"
#define QAPP_APP_NAME_TESTNET "PWRB-Qt-testnet"
