...
/** Utility functions used by the PWRB Qt UI.
 */
namespace GUIUtil
{
...
// Render PWRB addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZpwrb = false);
...
// Parse "pwrb:" URI into recipient object, return true on successful parsing
