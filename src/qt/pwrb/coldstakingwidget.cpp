...
#include "qt/pwrb/forms/ui_coldstakingwidget.h"
#include "qt/pwrb/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/pwrb/requestdialog.h"
#include "qt/pwrb/tooltipmenu.h"
#include "qt/pwrb/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(PWRBGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your PWRBs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept PWRB delegation / Delegate PWRB"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select PWRB outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 PWRB" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
