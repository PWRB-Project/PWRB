...
#include "config/pwrb-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalPwrb = 0;
    qint64 totalZpwrb = 0;
    QList<qreal> valuesPwrb;
    QList<qreal> valueszPwrb;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(PWRBGUI* _window);
    ~DashboardWidget();
