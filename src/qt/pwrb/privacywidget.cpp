    ...
    ui(new Ui::PrivacyWidget)
{
    ...
    ui->btnTotalzPWRB->setTitleClassAndText("btn-title-grey", tr("Total 0 zPWRB"));
    ui->btnTotalzPWRB->setSubTitleClassAndText("text-subtitle", tr("Show denominations of zPWRB owned."));
    ui->btnTotalzPWRB->setRightIconClass("ic-arrow");

    ui->btnCoinControl->setTitleClassAndText("btn-title-grey", tr("Coin Control"));
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", tr("Select PWRB outputs to mint into zPWRB."));
    ...
    ui->btnResetZerocoin->setTitleClassAndText("btn-title-grey", tr("Reset Spent zPWRB"));
