...
#include "qt/pwrb/settings/settingsfaqwidget.h"
...
const QString PWRBGUI::DEFAULT_WALLET = "~Default";

PWRBGUI::PWRBGUI(const NetworkStyle* networkStyle, QWidget* parent) :
        QMainWindow(parent),
        clientModel(0){
    ...
    if (enableWallet) {
        ...
        stackedContainer->addWidget(betWidget);
...
void PWRBGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    connect(toggleHideAction, &QAction::triggered, this, &PWRBGUI::toggleHidden);
...
void PWRBGUI::connectActions()
{
    ...
    connect(topBar, &TopBar::showHide, this, &PWRBGUI::showHide);
    connect(topBar, &TopBar::themeChanged, this, &PWRBGUI::changeTheme);
    connect(topBar, &TopBar::onShowHideColdStakingChanged, navMenu, &NavMenuWidget::onShowHideColdStakingChanged);
    connect(settingsWidget, &SettingsWidget::showHide, this, &PWRBGUI::showHide);
    connect(betWidget, &BetWidget::showHide, this, &PWRBGUI::showHide);
    connect(sendWidget, &SendWidget::showHide, this, &PWRBGUI::showHide);
    connect(receiveWidget, &ReceiveWidget::showHide, this, &PWRBGUI::showHide);
    connect(addressesWidget, &AddressesWidget::showHide, this, &PWRBGUI::showHide);
    connect(coldStakingWidget, &ColdStakingWidget::showHide, this, &PWRBGUI::showHide);
    connect(coldStakingWidget, &ColdStakingWidget::execDialog, this, &PWRBGUI::execDialog);
    connect(settingsWidget, &SettingsWidget::execDialog, this, &PWRBGUI::execDialog);
}
...
void PWRBGUI::setClientModel(ClientModel* clientModel)
{
    ...
    if (this->clientModel) {
        ...
        betWidget->setClientModel(clientModel);
        sendWidget->setClientModel(clientModel);
        settingsWidget->setClientModel(clientModel);

        // Receive and report messages from client model
        connect(clientModel, &ClientModel::message, this, &PWRBGUI::message);
...
void PWRBGUI::createTrayIconMenu()
{
    ...
    connect(trayIcon, &QSystemTrayIcon::activated, this, &PWRBGUI::trayIconActivated);
#else
    // Note: On macOS, the Dock icon is used to provide the tray's functionality.
    MacDockIconHandler* dockIconHandler = MacDockIconHandler::instance();
    connect(dockIconHandler, &MacDockIconHandler::dockIconClicked, this, &PWRBGUI::macosDockIconActivated);
...
#ifndef Q_OS_MAC
void PWRBGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
#else
void PWRBGUI::macosDockIconActivated()
 {
     show();
     activateWindow();
 }
...
void PWRBGUI::changeEvent(QEvent* e)
{
    ...
    if (e->type() == QEvent::WindowStateChange) {
        if (clientModel && clientModel->getOptionsModel() && clientModel->getOptionsModel()->getMinimizeToTray()) {
            ...
            if (!(wsevt->oldState() & Qt::WindowMinimized) && isMinimized()) {
                QTimer::singleShot(0, this, &PWRBGUI::hide);
                e->ignore();
            }
        }
    }
...
void PWRBGUI::closeEvent(QCloseEvent* event)
{
#ifndef Q_OS_MAC // Ignored on Mac
...
bool PWRBGUI::openStandardDialog(QString title, QString body, QString okBtn, QString cancelBtn)
{
    ...
    if (isVisible()) {
        ...
        dialog->setWindowTitle(tr("PWRB Core"));
        dialog->adjustSize();
        dialog->raise();
        dialog->exec();
    }
...
bool PWRBGUI::addWallet(const QString& name, WalletModel* walletModel)
{
    ...
    betWidget->setWalletModel(walletModel);
    ...
    connect(sendWidget, &SendWidget::message,this, &PWRBGUI::message);
    connect(receiveWidget, &ReceiveWidget::message,this, &PWRBGUI::message);
    connect(addressesWidget, &AddressesWidget::message,this, &PWRBGUI::message);
    connect(settingsWidget, &SettingsWidget::message, this, &PWRBGUI::message);

    // Pass through transaction notifications
    connect(dashboard, &DashboardWidget::incomingTransaction, this, &PWRBGUI::incomingTransaction);
...
static bool ThreadSafeMessageBox(PWRBGUI* gui, const std::string& message, const std::string& caption, unsigned int style)
{
...
void PWRBGUI::subscribeToCoreSignals()
{
    // Connect signals to client
    uiInterface.ThreadSafeMessageBox.connect(boost::bind(ThreadSafeMessageBox, this, _1, _2, _3));
}

void PWRBGUI::unsubscribeFromCoreSignals()
{
