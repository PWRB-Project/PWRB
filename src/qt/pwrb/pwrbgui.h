...
#ifndef PWRB_CORE_NEW_GUI_PWRBGUI_H
#define PWRB_CORE_NEW_GUI_PWRBGUI_H
...
#include "qt/pwrb/send.h"
#include "qt/pwrb/receivewidget.h"
#include "qt/pwrb/addresseswidget.h"
#include "qt/pwrb/coldstakingwidget.h"
...
/**
  PWRB GUI main class. This class represents the main window of the PWRB UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class PWRBGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit PWRBGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~PWRBGUI();
...
#endif //PWRB_CORE_NEW_GUI_PWRBGUI_H
