...
void closeDialog(QDialog* widget, PWRBGUI* gui)
{
    widget->setWindowFlags(Qt::CustomizeWindowHint);
    widget->setAttribute(Qt::WA_TranslucentBackground, true);
    QPropertyAnimation* animation = new QPropertyAnimation(widget, "pos");
...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, PWRBGUI* gui, double posX, int posY)
{
    widget->setWindowFlags(Qt::CustomizeWindowHint);
    widget->setAttribute(Qt::WA_TranslucentBackground, true);
    QPropertyAnimation* animation = new QPropertyAnimation(widget, "pos");
...
bool openDialogWithOpaqueBackground(QDialog* widget, PWRBGUI* gui, double posX)
{
    return openDialogWithOpaqueBackgroundY(widget, gui, posX, 5);
}

bool openDialogWithOpaqueBackgroundFullScreen(QDialog* widget, PWRBGUI* gui)
{
    widget->setWindowFlags(Qt::CustomizeWindowHint);
    widget->setAttribute(Qt::WA_TranslucentBackground, true);
...
void setSortTxTypeFilter(QComboBox* filter, SortEdit* lineEditType)
{
    ...
    filter->addItem(QObject::tr("Bets"), TransactionFilterProxy::TYPE(TransactionRecord::Bet));
    filter->addItem(QObject::tr("Winnings"), TransactionFilterProxy::TYPE(TransactionRecord::BetWin));
