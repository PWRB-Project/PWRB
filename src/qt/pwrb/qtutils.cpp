...
void setSortTxTypeFilter(QComboBox* filter, SortEdit* lineEditType) {
    ...
    filter->addItem(filter->tr("Bets"), TransactionFilterProxy::TYPE(TransactionRecord::Bet));
    filter->addItem(filter->tr("Winnings"), TransactionFilterProxy::TYPE(TransactionRecord::BetWin));
