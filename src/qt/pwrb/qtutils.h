...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, PWRBGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, PWRBGUI* gui, double posX = 3);
