...
#include "qt/pwrb/forms/ui_receivewidget.h"
...
#include "qt/pwrb/addressholder.h"
...
ReceiveWidget::ReceiveWidget(PWRBGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive PWRB."));
