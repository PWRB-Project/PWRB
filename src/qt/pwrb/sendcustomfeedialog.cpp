...
#include "qt/pwrb/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(PWRBGUI *parent) :
    QDialog(parent),
    ui(new Ui::SendCustomFeeDialog)
{
    ...
    if (parent)
        connect(parent, &PWRBGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
