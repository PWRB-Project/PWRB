...
#include "qt/pwrb/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/pwrb/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(PWRBGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory){
    ...
    message(CMD_REPLY, (tr("Welcome to the PWRB RPC console.") + "<br>" +
