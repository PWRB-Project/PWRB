...
#include "qt/pwrb/settings/settingsexportcsv.h"
#include "qt/pwrb/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(PWRBGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("PWRB_tx_csv_export(*.csv)") : tr("PWRB_addresses_csv_export(*.csv)"),
                                        nullptr);
