...
#include "qt/pwrb/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/pwrb/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(PWRBGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    // Web Link
    ui->pushButtonWebLink->setText("https://powerbalt.com/");
    ...
    if (parent)
        connect(parent, &PWRBGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
