...
#include "qt/pwrb/settings/settingsnetworkwidget.h"
#include "qt/pwrb/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/pwrb/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(PWRBGUI* _window, QWidget *parent) :
