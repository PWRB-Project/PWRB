...
#include "qt/pwrb/settings/settingssignmessagewidgets.h"
#include "qt/pwrb/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(PWRBGUI* _window, QWidget *parent) :
