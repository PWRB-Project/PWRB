...
#include "qt/pwrb/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/pwrb/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(PWRBGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to PWRBGUI::handleRestart()
