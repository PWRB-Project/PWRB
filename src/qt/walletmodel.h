...
#ifndef PWRB_QT_WALLETMODEL_H
#define PWRB_QT_WALLETMODEL_H
...
/** Interface to PWRB wallet from Qt view code. */
...
public:
    ...
    bool validateBet(const QString& address);
    CScript parseBet(const QString& address);
