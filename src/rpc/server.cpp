...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PWRB features */
        {"pwrb", "listmasternodes", &listmasternodes, true, true, false},
        {"pwrb", "getmasternodecount", &getmasternodecount, true, true, false},
        {"pwrb", "masternodeconnect", &masternodeconnect, true, true, false},
        {"pwrb", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"pwrb", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"pwrb", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"pwrb", "masternodecurrent", &masternodecurrent, true, true, false},
        {"pwrb", "masternodedebug", &masternodedebug, true, true, false},
        {"pwrb", "startmasternode", &startmasternode, true, true, false},
        {"pwrb", "createmasternodekey", &createmasternodekey, true, true, false},
        {"pwrb", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"pwrb", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"pwrb", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"pwrb", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"pwrb", "getmasternodescores", &getmasternodescores, true, true, false},
        {"pwrb", "preparebudget", &preparebudget, true, true, false},
        {"pwrb", "submitbudget", &submitbudget, true, true, false},
        {"pwrb", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"pwrb", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"pwrb", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"pwrb", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"pwrb", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"pwrb", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"pwrb", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"pwrb", "checkbudgets", &checkbudgets, true, true, false},
        {"pwrb", "mnsync", &mnsync, true, true, false},
        {"pwrb", "spork", &spork, true, true, false},
        ...
        {"zerocoin", "getzpwrbseed", &getzpwrbseed, false, false, true},
        {"zerocoin", "setzpwrbseed", &setzpwrbseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzpwrb", &searchdzpwrb, false, false, true},
        {"zerocoin", "dzpwrbstate", &dzpwrbstate, false, false, true},
...
{
    return "> pwrb-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:12301/\n";
}
