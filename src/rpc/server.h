...
extern UniValue setzpwrbseed(const UniValue& params, bool fHelp);
extern UniValue getzpwrbseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzpwrb(const UniValue& params, bool fHelp);
extern UniValue dzpwrbstate(const UniValue& params, bool fHelp);
