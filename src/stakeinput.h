...
#ifndef PWRB_STAKEINPUT_H
#define PWRB_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZPWRB() const = 0;
    virtual CDataStream GetUniqueness() const = 0;
    virtual bool ContextCheck(int nHeight, uint32_t nTime) = 0;
};


class CPwrbStake : public CStakeInput
{
private:
...
public:
    ...
    bool IsZPWRB() const override { return false; }
    bool ContextCheck(int nHeight, uint32_t nTime) override;
};


#endif //PWRB_STAKEINPUT_H
