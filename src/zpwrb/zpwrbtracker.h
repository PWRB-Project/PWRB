...
#ifndef PWRB_ZPWRBTRACKER_H
#define PWRB_ZPWRBTRACKER_H
...
public:
    CzPWRBTracker(CWallet* parent);
    ~CzPWRBTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzPWRBWallet* zPWRBWallet = NULL);
