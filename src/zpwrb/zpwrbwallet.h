...
#ifndef PWRB_ZPWRBWALLET_H
#define PWRB_ZPWRBWALLET_H
...
public:
    ...
    void GenerateDeterministicZPWRB(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZPWRB(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
