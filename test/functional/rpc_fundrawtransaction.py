...
class RawTransactionsTest(PwrbTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid pwrb address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid pwrb address" in e.error['message'])
